import {
  ...
  export const decompressFile = async (line) => {
    ...
    const fullPathToNewFile = join(fullDestinationPath, name)
    ...
    try {
      await compressDecompressFile(fullPathToFile, fullPathToNewFile, false)
    } catch {
      console.log('Operation failed')
    }
  }
